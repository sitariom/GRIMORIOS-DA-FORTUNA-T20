...
export const CATEGORY_CONFIG: Record<ItemCategory, { label: string; icon: string; subcategories: string[] }> = {
  Arma: {
    ...
    icon: '⚔️',
    subcategories: [
      'Simples/Corpo a Corpo/Leve', 'Simples/Corpo a Corpo/Uma Mão', 'Simples/Corpo a Corpo/Duas Mãos',
      'Simples/Distância/Leve', 'Simples/Distância/Uma Mão', 'Simples/Distância/Duas Mãos',
      'Marcial/Corpo a Corpo/Leve', 'Marcial/Corpo a Corpo/Uma Mão', 'Marcial/Corpo a Corpo/Duas Mãos',
      'Marcial/Distância/Leve', 'Marcial/Distância/Uma Mão', 'Marcial/Distância/Duas Mãos',
      'Exótica/Corpo a Corpo', 'Exótica/Distância',
      'Fogo/Corpo a Corpo', 'Fogo/Distância',
      'Munição',
    ],
  },
  ArmaduraEscudo: {
